...
public class TeleOP extends OpMode {
    ...
    public void loop() {
        ...
        */
        ...
        if(gamepad1.dpad_up)verticalSlidePos = Range.clip(verticalSlidePos + 30,0,6000);
        if(gamepad1.dpad_down) verticalSlidePos = Range.clip(verticalSlidePos - 30,0,6000);
