...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public List<Double> getWheelPositions() {
        return Arrays.asList(
                encoderTicksToInches(leftFrontLeftEnc.getCurrentPosition()),
                encoderTicksToInches(leftBackRightEnc.getCurrentPosition()),
                encoderTicksToInches(rightFrontBackEnc.getCurrentPosition())
        );
    }
    ...
    public List<Double> getWheelVelocities() {
        ...
        return Arrays.asList(
                encoderTicksToInches(leftFrontLeftEnc.getCorrectedVelocity()),
                encoderTicksToInches(leftBackRightEnc.getCorrectedVelocity()),
                encoderTicksToInches(rightFrontBackEnc.getCorrectedVelocity())
        );
    }
}
